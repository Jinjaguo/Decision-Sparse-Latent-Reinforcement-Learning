    ...
    try:
        with contextlib.redirect_stdout(captured_stdout), contextlib.redirect_stderr(captured_stderr):
            ...
            boundary_manifest = {
                ...
                "definition": "Snapshot t=0 is taken after reset_from_xml_string, sim.reset, set_init_state, post_process, forced observable update, controller.update(force=True), controller.reset_goal(), and setting controller.new_update=True. Snapshot t>0 is taken immediately after ControlEnv.step(actions[t-1]) returns and before ControlEnv.step(actions[t]) is called.",
